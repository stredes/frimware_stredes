...
#define UI_COLOR_STREDES_RETRO_PRI 0xBC9F
#define UI_COLOR_STREDES_RETRO_SEC 0xFAAA
#define UI_COLOR_STREDES_RETRO_BG 0x0000
...
static constexpr ColorEntry UI_COLORS[] = {
    ...
    {"stredes",       UI_COLOR_STREDES_RETRO_PRI, UI_COLOR_STREDES_RETRO_SEC, UI_COLOR_STREDES_RETRO_BG},
};
